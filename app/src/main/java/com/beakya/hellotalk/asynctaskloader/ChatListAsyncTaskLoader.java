...
public class ChatListAsyncTaskLoader extends AsyncTaskLoader<ArrayList<ChatRoom>> {
    ...
    public ArrayList<ChatRoom> loadInBackground() {
        ...
        String roomId = TalkContract.ChatRooms.CHAT_ID;
        ...
        String query = " SELECT " + " a.*, " + " ch." + TalkContract.ChatRooms.CHAT_ROOM_TYPE + " from " + TalkContract.ChatRooms.TABLE_NAME + " as ch " +
                " join " + TalkContract.Message.TABLE_NAME + " as a ON " + "a."+ TalkContract.Message._ID + " = " +
                " ( " + "SELECT " + " b." + TalkContract.Message._ID + " from " + TalkContract.Message.TABLE_NAME  + " as b WHERE " + " b."+roomId + " = " + "ch." +roomId +
                " ORDER BY " + "b."+ TalkContract.Message._ID + " DESC limit 1 " + " ) ";
        ...
        while( cursor.moveToNext()) {
            db.beginTransaction();
            //채팅 id
            String chatRoomId = cursor.getString(cursor.getColumnIndex(TalkContract.ChatRooms.CHAT_ID));
            // 채팅 유저 쿼리
            String roomUsersQuery = " SELECT " + " b."+TalkContract.User.USER_NAME +" , " + " a."+TalkContract.User.USER_ID + " FROM " + TalkContract.ChatUserRooms.TABLE_NAME + " as a "+
                    ...
                    "a."+ TalkContract.ChatRooms.CHAT_ID + " = " +"'"+ chatRoomId+"'";
            ...
            String lastContent = cursor.getString(cursor.getColumnIndex(TalkContract.Message.MESSAGE_CONTENT));
            int chatType = cursor.getInt(cursor.getColumnIndex(TalkContract.Message.MESSAGE_TYPE));
